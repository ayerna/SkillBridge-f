      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 px-4">
        <Card className="w-full max-w-md shadow-xl">
          <CardContent className="p-8 text-center">
            ...
            <h2 className="text-2xl font-bold mb-2">{isLogin ? "Login Verified!" : "Email Verified!"}</h2>
            <p className="text-muted-foreground mb-4">
              {isLogin
                ? "Your login has been verified. Redirecting to dashboard..."
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 px-4">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center relative">
          ...
          <CardTitle className="text-2xl">{isLogin ? "Verify Your Login" : "Verify Your Email"}</CardTitle>
